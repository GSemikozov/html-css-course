...
- подобрать материал базовый html css - до курса
- позиционирование - relative, absolute, static, fixed, sticky + паттерны использования
- подумать над тем можно ли использовать в проекте css-modules - сделать пример сборки
